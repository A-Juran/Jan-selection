...
import { TradeMarkResponseDataType, TradeMarkDataType } from '@/api/product/trademark/type'
//接口
enum API {
 ...
 * @returns 
 */
export const delTradeMark = (id: number) => request.delete<any, any>(API.DEL_TRADEMARK_INFO_URL + `/${id}`)
